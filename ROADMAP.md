...
8. **Element protrusion research - current.** Prototype conservative child-vs-parent boundary evidence as a distinct component-local failure family. Keep generic collision deferred until stronger evidence justifies its false-positive cost.
