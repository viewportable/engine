...
- Repo route files, same-origin sitemap urlsets, and a Next.js production-manifest adapter are now implemented as bounded discovery inputs. Other framework manifests and constrained crawl remain later discovery inputs.
