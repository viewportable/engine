...
import { AgentEvidenceV3Schema, type AgentEvidenceV3 } from './contracts/agent-evidence-v3.js';
...
const outputSchema = AgentEvidenceV3Schema;

function toolResult(result: AgentEvidenceV3) {
  return {
